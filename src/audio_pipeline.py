    ...
    try:
        ...
        while True:
            try:
                ...
                # COMMENTED OUT: Process audio for wake-word detection
                # detection_result = wake_detector.process_audio(audio_data)
                
                # COMMENTED OUT: DEBUG: Always log confidence scores to see what the neural model is producing
                # try:
                ...
                # COMMENTED OUT: Wake word detection disabled for RMS testing
                # if detection_result:
